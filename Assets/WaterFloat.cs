...
public class WaterFloat : MonoBehaviour
{
    ...
    public float maxHeightPossible = 4f;
    ...
    void Awake()
    {
        ...
        // var waterLinePointsCenter = Vector3.zero;
        //for (int i = 0; i < WaterLinePoints.Length; i++)
        //    waterLinePointsCenter += WaterLinePoints[i] / WaterLinePoints.Length;
        // centerOffset = waterLinePointsCenter - transform.position;
    ...
    void FixedUpdate()
    {
        ...
        // Hard limit
        if (transform.position.y > maxHeightPossible)
            Rigidbody.position = new Vector3(Rigidbody.position.x, maxHeightPossible, Rigidbody.position.z);
    ...
    // PHYSICS HELPER: https://github.com/ditzel/UnityOceanWavesAndShip/blob/master/Waves/Assets/PhysicsHelper.cs
